    ...
    <section className="border-t border-border px-8 py-24">
      <div className="grid gap-px overflow-hidden rounded-lg border border-border md:grid-cols-2">
        <div className="bg-card p-10">
          <HouseIcon size={26} weight="regular" />
          <h3 className="mt-6 text-2xl font-medium">Have spare hardware?</h3>
        ...
        <div className="bg-card p-10">
          <RocketLaunchIcon size={26} weight="regular" />
          <h3 className="mt-6 text-2xl font-medium">Need compute for a job?</h3>
          <p className="mt-3 max-w-sm text-base text-muted-foreground">
